	...
	.globl	__Z10dotProductPiS_i    ## -- Begin function _Z10dotProductPiS_i
	.p2align	4, 0x90
__Z10dotProductPiS_i:                   ## @_Z10dotProductPiS_i
	.cfi_startproc
## %bb.0:
	push	rbp
...
## %bb.0:
	...
	lea	rsi, [rbp - 24]
	lea	rdi, [rbp - 16]
	mov	rcx, qword ptr [rip + L___const.main._a]
	mov	qword ptr [rbp - 16], rcx
	mov	rcx, qword ptr [rip + L___const.main._b]
	mov	qword ptr [rbp - 24], rcx
	mov	edx, 2
	mov	qword ptr [rbp - 40], rax ## 8-byte Spill
	call	__Z10dotProductPiS_i
	mov	rdi, qword ptr [rip + __ZNSt3__14coutE@GOTPCREL]
...
L_.str:                                 ## @.str
	.asciz	"running function"

	.section	__TEXT,__literal8,8byte_literals
	.p2align	2               ## @__const.main._a
L___const.main._a:
	.long	1                       ## 0x1
	.long	2                       ## 0x2

	.p2align	2               ## @__const.main._b
L___const.main._b:
	.long	1                       ## 0x1
	.long	2                       ## 0x2
