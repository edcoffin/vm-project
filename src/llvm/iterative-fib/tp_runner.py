...
# additional statistics on when first execution occurs
first_execution = [];
results = {}
...
last_bucket = sorted(list(results.keys()))[-1]
...
print("First execution statistics:")
avg = sum(first_execution) / len(first_execution)
std = statistics.stdev(first_execution)
confidence = std / math.sqrt(len(first_execution))
print("Mean: {}, Std: {}, Error: {}".format(avg, std, confidence))