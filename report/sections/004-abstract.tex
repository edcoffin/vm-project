\begin{abstract}
    Just-in-Time compilation has allowed for significant performance gains by applications.
    ...
    In addition, we attempt to measure the overhead of each framework while compiling and then executing a small handful of test.
